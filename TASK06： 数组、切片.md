...
func main() {
	...
	for i := 0; i < 5; i++ {
		temp := i
		a[i] = &temp //a[i]为地址值，但a[0]、a[1]、a[2]、a[3]、a[4]都不相同。
	}
	for i := 0; i < 5; i++ {
...
var s1 = []int{}  //[]
//方法二
var s2 = []int{1, 2, 3}  //[1 2 3]
//方法三
var s3 = make([]int, 5)  //[0 0 0 0 0]
//方法四
var s4 = make([]int, 5, 10)  //[0 0 0 0 0]
```
...
func main() {
	...
	a = append(a, b...)  //如果写成a = append(a, b)则出错
	fmt.Println(a)
}
```
